define({ "api": [
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:6002/api/distribute/dis_info",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "/api/distribute/dis_info"
      }
    ],
    "error": {
      "examples": [
  ...
  {
    "type": "get",
    "url": "/distribute/pop_link",
    "title": "推广链接",
    "group": "推广分享",
    "description": "<p>获取分销分销商推广链接</p>",
    "header": {
      "fields": {
        "Header": [
          {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://localhost:6002/api/distribute/pop_link",
        "type": "curl"
      }
    ],
    "sampleRequest": [
      {
        "url": "/api/distribute/pop_link"
      }
    ],
    "error": {
      "examples": [
