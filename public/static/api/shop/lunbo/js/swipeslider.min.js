! function(n) {
	n.fn.swipeslider = function(i) {
		...
		function E() {
			B.after('<span class="sw-next-prev sw-prev" style="display:none"></span>'), D.find(".sw-prev").click(function() {
				L && (l(), w(), a())
			}), B.after('<span class="sw-next-prev sw-next" style="display:none"></span>'), D.find(".sw-next").click(function() {
				L && (l(), d(), a())
			})
		}
